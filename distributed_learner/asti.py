...
class Asti:
    ...
    def init_client():
        ...
        rightLegJoints = [rightLegJoint0, rightLegJoint1, rightLegJoint2, rightLegJoint3, rightLegJoint4,
                          rightLegJoint5]
        self.handles = [joint_handle for joint_handle_cluster in
                        [neckJoints, leftArmJoints, rightArmJoints, leftLegJoints, rightLegJoints] for joint_handle in
                        joint_handle_cluster]
    ...
    def set_forces(force_vec):
        ...
        for handle_idx in range(0, self.joint_count):
            _ = vrep.simxSetJointForce(self.client_id, self.handles[handle_idx], force_vec[handle_idx],
