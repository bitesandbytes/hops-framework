...
def create_actor(state_size, action_size):
    with tf.device("/cpu:0"):
        ...
        h0 = Dense(50, init='random_normal', activation='relu')(S)
        ...
        h1 = Dense(100, init='random_normal', activation='relu')(h0)
        # A = Activation('sigmoid')(BatchNormalization()(Dense(action_size, init='random_normal')(h1), training=True))
        A = 15 * Dense(action_size, init='random_normal', activation='tanh')(h1)
...
def create_critic(state_size, action_size):
    with tf.device("/cpu:0"):
        ...
        # HIDDEN1_UNITS, relu
        w1 = Dense(50, init='random_normal', activation='relu')(S)
        # HIDDEN2_UNITS, linear
        a1 = Dense(100, init='random_normal', activation='relu')(A)
        # HIDDEN2_UNITS, linear
        # h1 = Activation('tanh')(BatchNormalization()(Dense(200, init='random_normal')(w1), training=True))
        h1 = Dense(100, init='random_normal', activation='tanh')(w1)
        h2 = merge([h1, a1], mode='mul')
        # HIDDEN2_UNITS, linear
        h3 = Dense(100, init='random_normal', activation='relu')(h2)
...
def create_emb_learner(state_size, goal_size, emb_size):
    with tf.device("/cpu:0"):
        ...
        S1 = Dense(50, init='random_normal', activation='relu')(emb_layer)
