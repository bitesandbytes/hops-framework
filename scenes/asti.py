...
class Asti:
    ...
    def init_client():
        ...
        e, neckJoint0 = vrep.simxGetObjectHandle(self.client_id, 'neckJoint0', vrep.simx_opmode_blocking)
        e, neckJoint1 = vrep.simxGetObjectHandle(self.client_id, 'neckJoint1', vrep.simx_opmode_blocking)
        neckJoints = [neckJoint0, neckJoint1]
        e, leftArmJoint0 = vrep.simxGetObjectHandle(self.client_id, 'leftArmJoint0', vrep.simx_opmode_blocking)
        e, leftArmJoint1 = vrep.simxGetObjectHandle(self.client_id, 'leftArmJoint1', vrep.simx_opmode_blocking)
        e, leftArmJoint2 = vrep.simxGetObjectHandle(self.client_id, 'leftArmJoint2', vrep.simx_opmode_blocking)
        leftArmJoints = [leftArmJoint0, leftArmJoint1, leftArmJoint2]
        e, rightArmJoint0 = vrep.simxGetObjectHandle(self.client_id, 'rightArmJoint0', vrep.simx_opmode_blocking)
        e, rightArmJoint1 = vrep.simxGetObjectHandle(self.client_id, 'rightArmJoint1', vrep.simx_opmode_blocking)
        e, rightArmJoint2 = vrep.simxGetObjectHandle(self.client_id, 'rightArmJoint2', vrep.simx_opmode_blocking)
        rightArmJoints = [rightArmJoint0, rightArmJoint1, rightArmJoint2]
        e, leftLegJoint0 = vrep.simxGetObjectHandle(self.client_id, 'leftLegJoint0', vrep.simx_opmode_blocking)
        e, leftLegJoint1 = vrep.simxGetObjectHandle(self.client_id, 'leftLegJoint1', vrep.simx_opmode_blocking)
        e, leftLegJoint2 = vrep.simxGetObjectHandle(self.client_id, 'leftLegJoint2', vrep.simx_opmode_blocking)
        e, leftLegJoint3 = vrep.simxGetObjectHandle(self.client_id, 'leftLegJoint3', vrep.simx_opmode_blocking)
        e, leftLegJoint4 = vrep.simxGetObjectHandle(self.client_id, 'leftLegJoint4', vrep.simx_opmode_blocking)
        e, leftLegJoint5 = vrep.simxGetObjectHandle(self.client_id, 'leftLegJoint5', vrep.simx_opmode_blocking)
        leftLegJoints = [leftLegJoint0, leftLegJoint1, leftLegJoint2, leftLegJoint3, leftLegJoint4, leftLegJoint5]
        e, rightLegJoint0 = vrep.simxGetObjectHandle(self.client_id, 'rightLegJoint0', vrep.simx_opmode_blocking)
        e, rightLegJoint1 = vrep.simxGetObjectHandle(self.client_id, 'rightLegJoint1', vrep.simx_opmode_blocking)
        e, rightLegJoint2 = vrep.simxGetObjectHandle(self.client_id, 'rightLegJoint2', vrep.simx_opmode_blocking)
        e, rightLegJoint3 = vrep.simxGetObjectHandle(self.client_id, 'rightLegJoint3', vrep.simx_opmode_blocking)
        e, rightLegJoint4 = vrep.simxGetObjectHandle(self.client_id, 'rightLegJoint4', vrep.simx_opmode_blocking)
        e, rightLegJoint5 = vrep.simxGetObjectHandle(self.client_id, 'rightLegJoint5', vrep.simx_opmode_blocking)
    ...
    def get_joint_pos():
        ...
        for handle_idx in range(0, self.joint_count):
            e, jpos[handle_idx] = vrep.simxGetJointPosition(self.client_id, self.handles[handle_idx], vrep.simx_opmode_blocking)
